...
import 'package:newsapi/presentation/pages/load_map.dart';
import 'package:newsapi/presentation/pages/map_ui.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
          ...
          initialRoute: LoadMap.routeName,
          routes: {
            LoadMap.routeName: (context) => const LoadMap(),
